...
//            self.captureLayer.contents=nil;
                        ...
                        [self.captureLayer drawViewHierarchyInRect:self.captureLayer.bounds afterScreenUpdates:NO];
...
-(BOOL) setUpWriter {
	...
	NSDictionary* videoCompressionProps = [NSDictionary dictionaryWithObjectsAndKeys:
										   [NSNumber numberWithDouble:size.width*size.height* 7.5], AVVideoAverageBitRateKey,
										   nil ];
   
	
	NSDictionary* videoSettings = [NSDictionary dictionaryWithObjectsAndKeys:
								   AVVideoCodecH264, AVVideoCodecKey,
								   [NSNumber numberWithInt:size.width * kScreenScale], AVVideoWidthKey,
								   [NSNumber numberWithInt:size.height * kScreenScale], AVVideoHeightKey,
	...
	NSDictionary* bufferAttributes = [NSDictionary dictionaryWithObjectsAndKeys:
									  [NSNumber numberWithInt:kCVPixelFormatType_32ARGB], kCVPixelBufferPixelFormatTypeKey, [NSNumber numberWithInt:32], kCVPixelBufferBytesPerRowAlignmentKey, @YES ,kCVPixelBufferCGBitmapContextCompatibilityKey,@(kCVPixelFormatType_32BGRA),kCVPixelBufferPixelFormatTypeKey,nil];
    ...
    if (context== NULL)
    {
        ...
        context = CGBitmapContextCreate (NULL,
                                         size.width * kScreenScale,
                                         size.height * kScreenScale,
                                         8,//bits per component
                                         0,
                                         colorSpace,
                                         kCGImageAlphaNoneSkipFirst);
        CGColorSpaceRelease(colorSpace);
        CGContextScaleCTM(context, kScreenScale, kScreenScale);
